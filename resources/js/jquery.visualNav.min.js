...
(function(c) {
    c.visualNav = function(h, k) {
        ...
        a.init = function() {
            ...
            c.each(b.easing, function(a, d) { c.isFunction(c.easing[d]) || (b.easing[a] = "swing") });
            ...
            a.$win.bind(["scroll", "resize", ""].join(a.namespace + " "), function() { a.throttle() });
            a.update();
        ...
        a.update = function() {
            ...
            a.$links = c(a.$el.find(b.selectedAppliedTo + (b.selectedAppliedTo === b.link ? "" : " " + b.link)).map(function(a, b) { d = c(b); return d.hasClass(e) || d.closest(e).length ? null : b }));
            e = "." + b.contentLinks;
            a.$links.add(c(e + "," + e + " a")).unbind("click.visualNav").bind("click.visualNav", function(d, e) { var l = c(this);
                a.animate(l.attr(b.targetAttr) || l.attr("href"), e); return !1 });
            a.$items = b.selectedAppliedTo === b.link ? a.$links : c(a.$links.map(function() { return c(this).closest(b.selectedAppliedTo)[0] }));
        ...
        a.animate = function(d, e) {
            ...
            "#" !== d && g.length && (f = c(d).eq(0).closest("." + b.contentClass), f.length && (g = f), g.length && (a.curHash = g[0].id || "", a.$curContent = g, a.initialized && "function" === typeof b.beforeAnimation && b.beforeAnimation(a, g), f = g.offset(), l = Math.min(f.top, a.$doc.height() - a.$win.height()) - b.offsetTop, g = "function" === typeof b.animationTime ? b.animationTime(Math.abs(a.$body.scrollTop() - l)) || 1200 : b.animationTime, a.$body.stop().animate({
                ...
                scrollTop: l
            }, { queue: !1, duration: a.initialized ? g : 0, easing: b.easing[0], specialEasing: { scrollLeft: b.easing[0] || "swing", scrollTop: b.easing[1] || b.easing[0] || "swing" }, complete: function() { a.completed(e) } })))
        };
        a.throttle = function() { a.flag || (a.flag = !0, a.timer = setTimeout(function() { a.flag = !1;
                a.findLocation() }, 100)) };
        a.updateHash = function() {
            ...
            var f = (e || "").replace(/^#/, "");
            e && "" !== f && f !== a.curHash && (e = c("#" + f), a.curHash = f, e.length && (e.attr("id", ""), d = c("<div></div>").css({ position: "absolute", visibility: "hidden", top: c(document).scrollTop() + "px" }).attr("id", f).appendTo(document.body)), a.setHash("#" + f), e.length && (d.remove(), e.attr("id", f)))
        };
        a.setHash = function(b) { a.winLoc.hash !== b && "#" !== b && (a.winLoc.replace ? null !== a.history ? a.history.replaceState({}, "", b) : a.winLoc.replace(b) : a.winLoc.hash = b) };
        a.completed =
            function(c) { b.useHash && a.setHash("#" + a.curHash);
    ...
    c.fn.visualNav = function(h) { return this.each(function() { var k = c(this).data("visualNav");
            (typeof h).match("object|undefined") ? k ? k.update() : new c.visualNav(this, h) : "string" === typeof h && /^(#|\.)/.test(h) && k.animate(h) }) };
    c.fn.getvisualNav = function() { return this.data("visualNav") }
})(jQuery);